...
#### Reviewer Comments
I am happy that your project meets the required specifications. All the best as you upgrade P1 to P2 which has some interesting challenges on:
 * State restoration
 * Data persistence
 
Please check out an answer to your question in the code review section.
All the best as you build it.
